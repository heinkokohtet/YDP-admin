        ...
        <table class="table"  width="100%" cellspacing="0">
          ...
          <tbody>
            <tr>
              ...
              $result = mysqli_query($conn, "SELECT * FROM subcategories sc, coursecategories cs WHERE sc.coursecategory_id = cs.coursecategory_id ORDER BY sc.subcategory_id DESC");
              ...
              while($row = mysqli_fetch_assoc($result)): 
                ...
                <td value="<?php echo $row['coursecategory_id'] ?>">
                  <?php echo $row['coursecategory_name'] ?>
