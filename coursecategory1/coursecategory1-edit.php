...
<body>
  ...
  <?php 
    include('../config.php');
        ...
        $result = mysqli_query($conn, "SELECT * FROM coursecategories1 WHERE coursecategory_id = $coursecategory_id");
  ...
  ?>
      ...
      <div class="col-sm-10">
        <h4 class="header font-weight-bold text-dark">Edit Course Category 1</h4>
      </div>

      <div class="col-sm-2">

        <a href="coursecategory1-list.php">
    ...
    <div class="row">
      <div class="col col-sm-6" id="form">
	       ...
	       <form action="coursecategory1-update.php" method="post">
