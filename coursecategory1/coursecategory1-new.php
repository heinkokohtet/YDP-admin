...
<body>
  ...
  <?php 
      $result = mysqli_query($conn, "SELECT * FROM coursecategories1");
  ?>
 	...
 	<div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-sm-10">
          <h4 class="header font-weight-bold text-dark">Create New Course Category 1</h4>
        </div>
    ...
    <div class="row">
      <div class="col col-sm-6" id="form">
	       <form action="coursecategory1-add.php" method="post">
